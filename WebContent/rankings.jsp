...
<body>
	...
	<div class="menu">
		<a href="#"><button class="btn">
			...
			</button></a> <a href="<%="rankings.jsp?page="+pageid%>"><button class="btn">
	...
	<div>
		...
		<div>
			...
			<div>
				...
				<div class="row">
					<div class="column">
						<img src='<%="https://img.youtube.com/vi/" + top.get(i).getVideoId() + "/maxresdefault.jpg"%>'
							class="thumbnail" alt="" />
					</div>
					<div class="column">
					...
					<div class="column column-votes">
						...
						<p class="column-text" style="font-size: 3.5vmax; padding: 0%; margin: 2%"><%="#" + (i + 1)%>
						</p>
				...
				<div class="prev-next-field">
					...
					for (Integer i = pagerBegin; i <= pagerEnd; ++i) {
						if (i == pagerBegin) {
					%>
					<a href="<%="rankings.jsp?page=" + i%>"><button class="next button-cicrle">First page</button></a>
					<%
						} else if (i == pagerEnd) {
					%>
					<a href="<%="rankings.jsp?page=" + i%>"><button class="next button-cicrle">Last page</button></a>
					<%} else {%>
					<a href="<%="rankings.jsp?page=" + i%>"><button class="next button-cicrle"><%=i%></button></a>
					<%
						}
					}
					%>
